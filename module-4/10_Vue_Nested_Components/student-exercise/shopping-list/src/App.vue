...
<shopping-list title="Groceries List" v-bind:items="groceries" v-bind:search="search"></shopping-list>
<shopping-list title="My Costco List" v-bind:items="costco" v-bind:search="search"></shopping-list>
<shopping-list title="My Target List" v-bind:items="target" v-bind:search="search"></shopping-list>
</div>
</template>
